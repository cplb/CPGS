...
% i.e. it should be accompanied by an EPS file (Shadow_998_6-psfrag.eps). 
...
\psfrag{alpha}[cl][cl]{\PFGstyle {\LARGE$\alpha/M_\bullet$}}%
\psfrag{beta}[bc][bc]{\PFGstyle {\LARGE$\beta/M_\bullet$}}%
...
%
% Figure:
\resizebox{12cm}{!}{\includegraphics{Shadow_998_6-psfrag.eps}}%
\end{psfrags}%