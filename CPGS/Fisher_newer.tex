...
\bottomrule
\end{tabular}
\caption{Inverse Fisher matrix elements for the orbit specified in \figref{Nuttall}. The periapsis is $r\sub{p} = 52.7M_\bullet$, the SNR is $\rho = $.}
\label{tab:Fisher_3}
\end{sidewaystable}
\begin{sidewaystable}[htbp]\footnotesize
\centering
...
\bottomrule
\end{tabular}
\caption{Inverse Fisher matrix elements for the orbit specified in \figref{Orbit_1}. The periapsis is $r\sub{p} = 4.67M_\bullet$, the SNR is $\rho = $.}
\label{tab:Fisher_1}
\end{sidewaystable}
\begin{sidewaystable}[htbp]\footnotesize
\centering
...
\bottomrule
\end{tabular}
\caption{Inverse Fisher matrix elements for the orbit specified in \figref{Orbit_2}. The periapsis is $r\sub{p} = 11.77M_\bullet$, the SNR is $\rho = $.}
\label{tab:Fisher_2}
\end{sidewaystable}
\begin{sidewaystable}[htbp]\footnotesize
\centering
...
\bottomrule
\end{tabular}
\caption{Inverse Fisher matrix elements for the orbit specified in \figref{Orbit_5}. The periapsis is $r\sub{p} = 53.7M_\bullet$, the SNR is $\rho = $.}
\label{tab:Fisher_5}
\end{sidewaystable}
\begin{sidewaystable}[htbp]\footnotesize
\centering
...
\bottomrule
\end{tabular}
\caption{Inverse Fisher matrix elements for the orbit specified in \figref{Orbit_6}. The periapsis is $r\sub{p} = 22.7M_\bullet$, the SNR is $\rho = $.}
\label{tab:Fisher_6}
\end{sidewaystable}
\begin{sidewaystable}[htbp]\footnotesize
\centering
...
\bottomrule
\end{tabular}
\caption{Inverse Fisher matrix elements for the orbit specified in \figref{Orbit_7}. The periapsis is $r\sub{p} = 148M_\bullet$, the SNR is $\rho = $.}
\label{tab:Fisher_7}
\end{sidewaystable}
