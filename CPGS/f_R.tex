...
This degeneracy may be broken using other tests. From \eqnref{f(R)_Schw} we can calculate the post-Newtonian parameter $\gamma$, which measures the space-curvature produced by unit rest mass\cite{Will2006}, we find\cite{Olmo2007, DeFelice2010}
\begin{equation}
