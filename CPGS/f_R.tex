...
\end{equation}
Note that as $\Upsilon \rightarrow \infty$, the GR value of $\gamma = 1$ is recovered. As this is a function of position it is not immediately obvious how to apply this to standard tests; however it is clear that to be consistent with the current observational values of $1 + (2.1 \pm 2.3) \times 10^{-5}$\cite{Will2006, Bertotti2003} we must require $\Upsilon r \gg 1$ on solar system scales. This excludes the larger range for $\lambdabar_R$.
