...
Let us now apply this to the classic test of planetary precession in the solar system. \Tabref{Precess} shows the orbtial properties of planets in the solar system, we hope to use the deviation in perihelion precession rate from the GR prediction to constrain the value of $\zeta$, and hence $\Upslion$ and $a_2$.
\begin{table}[htbp]
\centering
\begin{tabular}{l D{.}{.}{4.6} D{.}{.}{3.8} D{.}{.}{3.3}@{$\,\pm\,$}D{.}{.}{2.3} D{.}{.}{1.8}}
\toprule
Planet & \multicolumn{1}{c}{Semimajor orbital axis\cite{Cox2000}} & & \multicolumn{1}{c}{Orbital period\cite{Cox2000}} & \multicolumn{2}{c}{Deviation from GR precession rate\cite{Pitjeva2009}} & \multicolumn{1}{c}{Orbital eccentricity\cite{Cox2000}} \\
 & \multicolumn{1}{c}{$r/\SI{e9}{\metre}$} & \multicolumn{1}{c}{$\omega_0/\si{\yr}$} & \multicolumn{2}{c}{$\upDelta \varpi \pm \simga_{\upDelta \varpi}/\si{\milli\as\per\yr}$} & \multicolumn{1}{c}{$e$} \\
\midrule
...
\label{tab:Precess}
\end{table}
All of the precession rates are consistent with the GR prediction within their uncertainties. \Tabref{Constraint} shows the constraints for $\Upsilon$ and $a_3$ obtained by fitting to the deviation in precession rate $\upDelta \varpi$, the deviation plus its uncertainty $\upDelta \varpi + \simga_{\upDelta \varpi}$, and the devaition plus two times its uncertainty $\upDelta \varpi + 2\simga_{\upDelta \varpi}$.
\begin{table}[htbp]
\centering
\begin{tabular}{l D{.}{.}{1.4} D{.}{.}{5.1} D{.}{.}{1.4} D{.}{.}{5.1} D{.}{.}{1.4} D{.}{.}{5.1}}
\toprule
 & \multicolumn{2}{c}{Using $\upDelta \varpi$} & & \multicolumn{2}{c}{Using $\upDelta \varpi + \simga_{\upDelta \varpi}$} & \multicolumn{2}{c}{Using $\upDelta \varpi + 2\simga_{\upDelta \varpi}$} \\
