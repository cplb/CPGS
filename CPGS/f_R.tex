...
For the limiting case of a Newtonian source, such that
\begin{equation}
...
Fifth-force tests also permit $\lambdabar_R$ to be large. This degeneracy may be broken using other tests. From \eqnref{f(R)_Schw}, calculating the post-Newtonian parameter $\gamma$, which measures the space-curvature produced by unit rest mass\cite{Will2006}, we find\cite{Olmo2007c, DeFelice2010}
\begin{equation}
