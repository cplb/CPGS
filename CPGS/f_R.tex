...
This degeneracy may be broken using other tests. From \eqnref{f(R)_Schw} we can calculate the post-Newtonian parameter $\gamma$, which measures the space-curvature produced by unit rest mass\cite{Will2006}, we find\cite{Olmo2007c, DeFelice2010}
\begin{equation}
...
\upDelta \varpi = {} & \varpi - \varpi\sub{S} \\
 = {} & \pi\zeta(\Upsilon,r\sub{S},\overline{r}),
\end{align}
...
Let us now apply this to the classic test of planetary precession in the solar system. \Tabref{Precess} shows the orbtial properties of planets in the solar system, we hope to use the deviation in perihelion precession rate from the GR prediction to constrain the value of $\zeta$, and hence $\Upsilon$ and $a_2$.
\begin{table}[htbp]\footnotesize
\centering
\begin{tabular}{l D{.}{.}{4.6} D{.}{.}{3.8} r @{$\,\pm\,$} l D{.}{.}{1.8}}
\toprule
...
Planet & \multicolumn{1}{c}{$r/\SI{e9}{\metre}$} & \multicolumn{1}{c}{$\omega_0/\si{\yr}$} & \multicolumn{2}{c}{$\upDelta \varpi \pm \sigma_{\upDelta \varpi}/\si{\milli\as\per\yr}$} & \multicolumn{1}{c}{$e$} \\
\midrule
Mercury & 57.909175 & 0.24084445 & $-0.040$ & $\phantom{0}0.050$ & 0.20563069 \\
Venus & 108.20893 & 0.61518257 & $0.24\phantom{0}$ & $\phantom{0}0.33$ & 0.00677323 \\
Earth & 149.59789 & 0.99997862 & $0.06\phantom{0}$ & $\phantom{0}0.07$ & 0.01671022 \\
Mars & 227.93664 & 1.88071105 & $-0.07\phantom{0}$ & $\phantom{0}0.07$ & 0.09341233 \\
Jupiter & 778.41202 & 11.85652502 & $0.67\phantom{0}$ & $\phantom{0}0.93$ & 0.04839266 \\
Saturn & 1426.7254 & 29.42351935 & $-0.10\phantom{0}$ & $\phantom{0}0.15$ & 0.05415060 \\
Uranus & 2870.9722 & 83.74740682 & $-38.9\phantom{00}$ & $39.0$ & 0.04716771 \\
Neptune & 4498.2529 & 163.723204 & $-44.4\phantom{00}$ & $54.0$ & 0.00858587 \\
Pluto & 5906.3762 & 248.0208 & $28.4\phantom{00}$ & $25.1$ & 0.24880766 \\
\bottomrule
\end{tabular}
...
\label{tab:Precess}
\end{table}
All of the precession rates are consistent with the GR prediction within their uncertainties. \Tabref{Constraint} shows the constraints for $\Upsilon$ and $a_3$ obtained by fitting to the deviation in precession rate $\upDelta \varpi$, the deviation plus its uncertainty $\upDelta \varpi + \sigma_{\upDelta \varpi}$, and the devaition plus two times its uncertainty $\upDelta \varpi + 2\sigma_{\upDelta \varpi}$.
\begin{table}[htbp]\footnotesize
\centering
\begin{tabular}{l D{.}{.}{1.4} D{.}{.}{5.1} D{.}{.}{1.4} D{.}{.}{5.1} D{.}{.}{1.4} D{.}{.}{5.1}}
\toprule
 & \multicolumn{2}{c}{Using $\upDelta \varpi$} & \multicolumn{2}{c}{Using $\upDelta \varpi + \sigma_{\upDelta \varpi}$} & \multicolumn{2}{c}{Using $\upDelta \varpi + 2\sigma_{\upDelta \varpi}$} \\
Planet & \multicolumn{1}{c}{$\Upsilon/\SI{e-9}{\per\metre}$} & \multicolumn{1}{c}{$|a_2|/\SI{e18}{\metre^2}$} & \multicolumn{1}{c}{$\Upsilon/\SI{e-9}{\per\metre}$} & \multicolumn{1}{c}{$|a_2|/\SI{e18}{\metre^2}$} & \multicolumn{1}{c}{$\Upsilon/\SI{e-9}{\per\metre}$} & \multicolumn{1}{c}{$|a_2|/\SI{e18}{\metre^2}$} \\
\midrule
Mercury & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & 0.56 & 1.1 & 0.52 & 1.2 \\
Venus & 0.26 & 5.1 & 0.25 & 5.4 & 0.24 & 5.6 \\
Earth & 0.19 & 9.0 & 0.19 & 9.6 & 0.18 & 9.9 \\
Mars & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & 0.12 & 22 \\
Jupiter & 0.030 & 370 & 0.029 & 400 & 0.028 & 420 \\
Saturn & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & 0.018 & 1100 & 0.017 & 1200 \\
Uranus & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & 0.0081 & 5000 &  0.0058 & 9800 \\
Neptune & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & 0.0039 & 22000 & 0.0034 & 28000 \\
...
While the presence of negative deviations is evidence against $f(R)$-gravity, the tightest numerical constraint, obtained from the orbit of Mercury, is many orders of magnitude worse than obtained from laboratory tests in \secref{Fifth}. In fact, this bound is less stringent than the requirement that $\Upsilon r \ll 1$ over solar system scales. This is not surprising: for there to be a measurable precession effect the $f(R)$ modification to gravity must be significant, this implies that $\exp(-\Upsilon r)$ cannot be neglibly small.
